...
class StatisticActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.statistics.observe(this, Observer {
            ...
            tv_goal_for_score_average.text = it?.goalsAverage?.goalForAverage?.total.toString()
            tv_goal_against_score_average.text = it?.goalsAverage?.goalAgainstAverage?.total.toString()
        })
